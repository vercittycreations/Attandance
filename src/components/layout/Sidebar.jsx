...
import {
  LayoutDashboard, Clock, CheckSquare, Calendar,
  Trophy, User, Shield, X, Zap, Megaphone, MessageCircle
} from 'lucide-react';
...
const navItems = [
  ...
  { to: '/announcements', icon: Megaphone,       label: 'Company Updates' },
  { to: '/groups',        icon: MessageCircle,   label: 'Team Groups' },
